/* Data structure for the Armor type
 * To be invoked in the ArmorController
 * Currently used to hold the toString method and Armor related calculations.
 */
...
public class Armor {
	...
	private String armorVariant, armorValue, armorSlotType, armorBrandRoll, armorAttributeRoll1, armorAttributeValue1,
			armorAttributeRoll2, armorAttributeValue2, armorAttributeRoll3, armorAttributeValue3, armorAttributeRoll4,
			armorAttributeValue4, armorTalentRoll1, armorTalentRoll2;

	public Armor(String armorVariant, String armorValue, String armorSlotType, String armorBrandRoll,
			String armorAttributeRoll1, String armorAttributeValue1, String armorAttributeRoll2,
			String armorAttributeValue2, String armorAttributeRoll3, String armorAttributeValue3,
			String armorAttributeRoll4, String armorAttributeValue4, String armorTalentRoll1, String armorTalentRoll2) {
	...
	public String toString() {
		return armorBrandRolls + "," + armorSlotType + "," + armorBrandRoll + "," + armorAttributeRoll1 + ","
				+ armorAttributeValue1 + "," + armorAttributeRoll2 + "," + armorAttributeValue2 + ","
				+ armorAttributeRoll3 + "," + armorAttributeValue3 + "," + armorAttributeRoll4 + ","
				+ armorAttributeValue4 + "," + armorTalentRoll1 + "," + armorTalentRoll2;
	}
