...
public class SkillModView extends JPanel {
	...
	public SkillModView() {
//		skillNamesSlots = populateSkills(skillNamesSlots, new File("SkillMods/Skill Names and Slots.txt"));
...
//		}
		...
		//gbc_boxSkillName.fill = GridBagConstraints.HORIZONTAL;
		...
		//gbc_boxSkillSlot.fill = GridBagConstraints.HORIZONTAL;
...
//				}
				...
				//JCombobox doesn't like it if there duplicates in the array
				//jumps back to the first index in the array if duplicate is found
				//an infinite loop is possible if there are duplicates in the jcombobox
