...
//		lblArmorModRoll = new JLabel("Armor Mod Roll:");
//		GridBagConstraints gbc_lblArmorModRoll = new GridBagConstraints();
//		gbc_lblArmorModRoll.insets = new Insets(0,0,0,5);
//		gbc_lblArmorModRoll.gridx = 0;
//		gbc_lblArmorModRoll.gridy = 2;
//		
//		boxArmorModRoll = new JComboBox();
//		boxArmorModRoll.setModel(new DefaultComboBoxModel(armorModRolls));
//		GridBagConstraints gbc_boxArmorModRoll = new GridBagConstraints();
//		gbc_boxArmorModRoll.insets = new Insets(0,0,0,5);
//		gbc_boxArmorModRoll.gridx = 1;
//		gbc_boxArmorModRoll.gridy = 2;
...
//		add(lblArmorModRoll, gbc_lblArmorModRoll);
//		add(boxArmorModRoll, gbc_boxArmorModRoll);
